		...
		public function generate_shortcodes_dialog( $target = 'posts' ) {
			...
			foreach ( $this->dialog_groups as $group_id => $group_data ) {
				...
				$dialog_content .= '<div class="toolset-collapsible js-toolset-collapsible is-opened">'
					...
					. "</h4>";
				$dialog_content .= "\n";
				$dialog_content .= '<div class="toolset-collapsible__body toolset-shortcodes__group js-wpv-shortcode-gui-group-list' . $post_field_section_classname . '">';
				$dialog_content .= "\n";
				foreach ( $group_data['fields'] as $group_data_field_key => $group_data_field_data ) {
					if (
						...
						$dialog_content .= sprintf(
							'<button class="toolset-shortcode-button js-toolset-shortcode-button" onclick="WPViews.shortcodes_gui.insert_shortcode_with_no_attributes(\'%s\', \'%s\'); return false;">%s</button>',
						...
						$dialog_content .= sprintf(
							'<button class="toolset-shortcode-button js-toolset-shortcode-button" onclick="%s; return false;">%s</button>',
			...
			$out = '
			<div class="toolset-dialog__body toolset-shortcodes js-toolset-dialog__body '. $dropdown_class .'" id="toolset-dialog__body-' . rand() . '">'
				. "\n"
